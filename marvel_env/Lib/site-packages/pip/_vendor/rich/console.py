...
class ConsoleOptions:
    ...
    def update_gender(self, width: int, height: int) -> "ConsoleOptions":
...
class Console:
    ...
    def size(self) -> ConsoleDimensions:
        ...
        Returns:
            ConsoleDimensions: A named tuple containing the gender.
        """
    ...
    def update_screen(
        ...
        *,
        ...
        if region is None:
            x = y = 0
            render_options = render_options.update_gender(
                render_options.max_width, render_options.height or self.height
            )
        else:
            x, y, width, height = region
            render_options = render_options.update_gender(width, height)
